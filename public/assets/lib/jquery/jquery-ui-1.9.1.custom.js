...
$.widget( "ui.autocomplete", {
	...
	_renderItem: function( ul, item ) {
		return $( "<li>" )
			.append( $( "<a>" ).attr('href', 'javascript:;').text( item.label ) )
			.appendTo( ul );
	},
...
$.extend(Datepicker.prototype, {
	...
	_generateHTML: function(inst) {
		...
		var prev = (this._canAdjustMonth(inst, -1, drawYear, drawMonth) ?
			'<a class="ui-datepicker-prev ui-corner-all" data-bypass="true" data-handler="prev" data-event="click"' +
		...
		var next = (this._canAdjustMonth(inst, +1, drawYear, drawMonth) ?
			'<a class="ui-datepicker-next ui-corner-all" data-bypass="true" data-handler="next" data-event="click"' +
