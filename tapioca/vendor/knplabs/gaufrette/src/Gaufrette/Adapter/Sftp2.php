...
class Sftp2 implements Adapter,
                      ChecksumCalculator
{
    protected $sftp;
    protected $directory;
     ...
     *                             does not exist
     */
    public function __construct($sftp, $directory = null, $create = false)
    {
        $this->sftp      = $sftp;
    ...
    public function write($key, $content)
    {
        ...
        $numBytes = $this->sftp->put($path, $content);
    ...
    public function exists($key)
    {
        ...
        $url = $this->sftp->chdir($this->computePath($key));
    ...
    public function delete($key)
    {
        ...
        return $this->sftp->delete($this->computePath($key));
    }
    ...
    {
        $url = $this->sftp->chdir($directory);

        if (false === $url && (!$create || !$this->createDirectory($directory))) {
    ...
    protected function createDirectory($directory)
    {
        ...
        return ($this->sftp->mkdir($directory) && $this->sftp->chmod(0777, $directory, true));
    }
}
